...
# ╔═╡ 43b1862e-1fd9-11ed-02d1-31bbde830e97
using Plots, HDF5

# ╔═╡ adf5d40e-ba79-4c0a-a3ca-bcc6673c6a5a
begin
	#=
	X = 2*rand(100, 2) .- 1
	y = zeros(100)
	...
	X, y = loaddata("/Users/hervesv/Desktop/Stuff/Projects/julia_scripts/ML/src/trainset.hdf5", 1000)
	

		
end

# ╔═╡ f75c5b89-3be1-4741-b228-360e762ad716
begin
...
# ╔═╡ c290a109-4a7f-4a5f-9b72-0c40b27e7d95
begin
	σ(z) = 1/(1+ℯ^(-z))
...
# ╔═╡ 56a19850-80a8-4f07-9617-5cb97096ef8c
begin
	# returns log loss
	function cost(A, y)
		m = size(y)[1]
...
# ╔═╡ 6a20eb74-c187-43d5-b2a4-6c5a064b952c
begin
...
# ╔═╡ 85abf58f-9346-4f06-bdcc-160a6b01e434
begin
...
# ╔═╡ 32efe412-a46a-4a3f-aa19-25e7d5017748
begin
...
# ╔═╡ 1edb9175-20d7-47fe-b743-214984501437
begin 
...
# ╔═╡ 5c5245a0-f58e-4397-844f-c80d65227840
begin
...
# ╔═╡ 2176adce-191e-451c-be10-6c91ef6b0a90
begin 
	W, b, losses = perceptron(X, y, 0.01)
...
# ╔═╡ 1a0a0a2a-e0ec-438b-95ae-b62aecd20bf6
begin
...
# ╔═╡ 33532ac7-ee40-4614-a0b9-2ca9819c0743
begin
	y_pred = predict(Xtest, W, b)
	println("Accuracy of ", accuracy(y_pred, y))
